  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <div class="title-container">
        <h3 class="title">Welcome to Phone Table</h3>
      </div>
      ...
      <el-form-item prop="password">
        ...
        <el-input :key="passwordType" ref="password" v-model="loginForm.password" :type="passwordType" placeholder="秘密"
...
.login-container {
  ...
  background-color: $bg;
  overflow: hidden;
  background-image: url('../../assets/404_images/9f5181392191dfad3142d0e8cc118a83.jpeg');
  /*登录窗口背景图*/
  background-size: 100%;
